...
3. Generate page with SaaS sample loaded
- Show the business name, offer, goals, CTA, platforms, and themes filled in.

4. Results page overview
- Capture the campaign title, summary, metrics, and campaign snapshot panel.

5. Calendar tab
- Show at least two cards with theme, caption, hashtags, image prompt, and CTA.

6. Marketing Scripts tab
- Capture the new marketing-scripts section to prove the app is broader than a simple caption generator.

7. Export tab
- Show the export cards, including Google Docs export.

8. Google Docs success state
